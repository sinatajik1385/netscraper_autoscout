...
def get_bmw() : 
    html_text = requests.get("https://www.autoscout24.com/lst/bmw?atype=C&cy=D%2CA%2CB%2CE%2CF%2CI%2CL%2CNL&damaged_listing=exclude&desc=0&powertype=kw&search_id=214f1obpp29&sort=standard&ustate=N%2CU").text
    ...
    for i in range (1, int(pages)) :
        i = str(i)
        html_text1 = requests.get ("https://www.autoscout24.com/lst/bmw?atype=C&cy=D%2CA%2CB%2CE%2CF%2CI%2CL%2CNL&damaged_listing=exclude&desc=0&page="+ i +"&powertype=kw&search_id=214f1obpp29&sort=standard&source=listpage_pagination&ustate=N%2CU").text
        ...
        for bmw in bmws :
            ...
            with open(f"F:\_net_scraping(autoscout)\\bmw\\bmw_{tracking_number}.txt", "w") as f :
                f.write(f"tracking no : {tracking_number} \n bmw name : \n {bmw_name} \n price of the bmw :\n {bmw_price} \n bmw advertisement : \n {bmw_link1} \n bmw image : \n {bmw_img_src1} \n bmw basic data : \n horse power : {horse_power} \n mileage : {mileage} \n date : {date} \n -------------------------------------------------------")


            print(f"bmw succesfully scraped !")
            print (f"\n ---------------------------------- \n")
        break
get_bmw()
