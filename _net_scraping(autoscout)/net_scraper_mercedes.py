...
def get_mercedes():
    html_text = requests.get("https://www.autoscout24.com/lst/mercedes-benz?atype=C&cy=D%2CA%2CB%2CE%2CF%2CI%2CL%2CNL&damaged_listing=exclude&desc=0&powertype=kw&search_id=qbdkxa96b6&sort=standard&source=homepage_search-mask&ustate=N%2CU").text
    ...
    for i in range (1, int(pages)) :
        i = str(i)
        html_text1 = requests.get ("https://www.autoscout24.com/lst/mercedes-benz?atype=C&cy=D%2CA%2CB%2CE%2CF%2CI%2CL%2CNL&damaged_listing=exclude&desc=0&page="+ i +"&powertype=kw&search_id=1xugf8nh0yd&sort=standard&source=listpage_pagination&ustate=N%2CU").text
        ...
        for bmw in bmws :
            ...
            with open(f"F:\_net_scraping(autoscout)\\mercedes\\mercedes_{tracking_number}.txt", "w") as f :
                f.write(f"tracking no : {tracking_number} \n mercedes name : \n {bmw_name} \n price of the mercedes :\n {bmw_price} \n mercedes advertisement : \n {bmw_link1} \n mercedes image : \n {bmw_img_src1} \n mercedes basic data : \n horse power : {horse_power} \n mileage : {mileage} \n date : {date} \n -------------------------------------------------------")


            print(f"mercedes succesfully scraped !")
            print (f"\n ---------------------------------- \n")
